...
{
++magchn;///
if ((magchn > 0) && ((normag > 0) && (enemyhp > 0)))///change from > 2, new
{
///++dubon;
///}moved below new
if (magchn <= 0)
...
printf("     You made a very well-timed manoeuvre!\n");
else if (diceQ == 3)
...
printf("     A very nice conclusion to the fight!\n");
else if (diceQ == 4)
